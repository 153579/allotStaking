...
$sql = "select * from g5_payment where mb_id = '{$member['mb_id']}' and pmt_type = 'DNB1' and pmt_del_yn = 'N' order by pmt_dttm desc";
$rtn = sql_query($sql);
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="container-title">
        <span class="container-title-content" data-i18n="sidebar:dnbplus">ALT STAKING BONUS</span>
    </div>
    <div class="row">
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-widget14 container-relative">
                    <div class="rico_float_right rico_right">
                        <p class="rico_bold" data-i18n="sidebar:dnbplus">ALT STAKING BONUS</p>
                        <p class="rico_mb0 rico_font30">
                            <?php echo round($total['pmt_price'] , 2); ?> ALT</p>
                    </div>
                                ...
                                <tbody>
									...
									?>
										<tr>
											...
											<th class="rico_center">ALT STAKING <span data-i18n="BONUSALL:Allowance">수당</span></th>
											<th class="rico_center"><?php echo $row['pmt_price']; ?> ALT</th>
											<th class="rico_center"><?php echo $row['pmt_price']+$row['pmt_bf_price'];?> ALT</th>
										</tr>
									<?php
										}	
									?>
