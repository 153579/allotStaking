...
$sql = "select * from g5_payment where mb_id = '{$member['mb_id']}' and pmt_type = 'DNB2' and pmt_del_yn = 'N' order by pmt_dttm desc";
$rtn = sql_query($sql);
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="container-title">
        <span class="container-title-content" data-i18n="sidebar:dnbplusplus">USD STAKING BONUS</span>
    </div>
    <div class="row">
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-widget14 container-relative">
                    <div class="rico_float_right rico_right">
                        <p class="rico_bold" data-i18n="sidebar:dnbplusplus">USD STAKING BONUS</p>
                        <p class="rico_mb0 rico_font30">
                            <?php echo round($total['pmt_price'] , 2); ?> USD</p>
                    </div>
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title container-card-title">
                            내역 </h3>
                    </div>
                                ...
                                <tbody>
									...
									?>
										<tr>
											...
											<th class="rico_center">USD STAKING <span data-i18n="BONUSALL:Allowance">수당</span></th>
											<th class="rico_center"><?php echo $row['pmt_price']; ?> USD</th>
											<th class="rico_center"><?php echo $row['pmt_price']+$row['pmt_bf_price'];?> USD</th>
										</tr>
									<?php
										}	
									?>
